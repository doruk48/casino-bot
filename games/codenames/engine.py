...
class GameRoom:
    ...
    def get_cell(self, word: str):
        """Kelimenin indeksini ve rolünü döndür."""
        try:
    ...
    def is_assassin_revealed(self):
        for i, r in enumerate(self.board_roles):
            if r == "assassin" and self.revealed_mask[i]:
                return True
        return False
